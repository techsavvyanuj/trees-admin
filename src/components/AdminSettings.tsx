    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3">
          <TabsTrigger value="admins" className="text-xs sm:text-sm">Admin Users</TabsTrigger>
          <TabsTrigger value="security" className="text-xs sm:text-sm">Security</TabsTrigger>
          <TabsTrigger value="activity" className="text-xs sm:text-sm">Activity Logs</TabsTrigger>
        </TabsList>
                  ...
                  <DialogTrigger asChild>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                        <Button onClick={handleAddAdmin} className="w-full sm:flex-1 text-sm">Add Admin</Button>
                        <Button variant="outline" onClick={() => setShowAddAdminDialog(false)} className="w-full sm:flex-1 text-sm">
                          Cancel
                        </Button>
                      </div>
                    </div>
            ...
            <CardContent>
              ...
              <div className="block sm:hidden space-y-3">
                {mockAdminUsers.map((admin) => (
                  <div key={admin.id} className="bg-white p-3 border rounded-lg space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-right">
                        ...
                        <Badge variant={admin.status === 'active' ? 'default' : 'secondary'} className="text-xs ml-1">
                          {admin.status}
                        </Badge>
                      </div>
                    </div>
